 ...
 */
public class SLayout extends ViewGroup {
    public SLayout(Context context) {
        super(context);
    }

    public SLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public SLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
