...
package com.test.test3app.windowtransition.gridtopager.adapter;

import static com.test.test3app.windowtransition.gridtopager.adapter.ImageData.IMAGE_DRAWABLES;
...
import com.test.test3app.windowtransition.gridtopager.MainActivity_google;
import com.test.test3app.windowtransition.gridtopager.adapter.GridAdapter.ImageViewHolder;
import com.test.test3app.windowtransition.gridtopager.fragment.ImagePagerFragment;
...
public class GridAdapter extends RecyclerView.Adapter<ImageViewHolder> {
    ...
    private static class ViewHolderListenerImpl implements ViewHolderListener {
        ...
        public void onLoadCompleted(ImageView view, int position) {
            ...
            if (MainActivity_google.currentPosition != position) {
                return;
            }
        ...
        public void onItemClicked(View view, int position) {
            // Update the position.
            MainActivity_google.currentPosition = position;
