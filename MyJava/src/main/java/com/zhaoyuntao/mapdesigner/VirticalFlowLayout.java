 ...
 */
public class VirticalFlowLayout extends FlowLayout {
    /**
     *
     */
    ...
    public static void main(String[] args) {
        ...
        frame.setLayout(new VirticalFlowLayout());
     ...
     */
    public VirticalFlowLayout(boolean hfill, boolean vfill) {
     ...
     */
    public VirticalFlowLayout(int align) {
     ...
     * @param vfill the vertical fill in pixels.
     */
    public VirticalFlowLayout(int align, boolean hfill, boolean vfill) {
     ...
     */
    public VirticalFlowLayout(int align, int hgap, int vgap, boolean hfill, boolean vfill) {
        setAlignment(align);
        this.hgap = hgap;
        this.vgap = vgap;
        this.hfill = hfill;
