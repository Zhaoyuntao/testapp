...
public class MessageStatusDrawableUtils {
    public static int getMessageStatusIcon(@MessageStatusCode int messageStatus, boolean white) {
        switch (messageStatus) {
            case MessageStatusCode.STATUS_MESSAGE_SEND_SENDING:
            case MessageStatusCode.STATUS_MESSAGE_SEND_SENDING_WAIT:
                return white ? R.drawable.svg_message_send_sending_white : R.drawable.svg_message_send_sending;
            case MessageStatusCode.STATUS_MESSAGE_SENDER_SEND_SUCCESS_RECEIVER_NOT_RECEIVE:
                return white ? R.drawable.svg_message_send_success_not_received_white : R.drawable.svg_message_send_success_not_received;
            case MessageStatusCode.STATUS_MESSAGE_SENDER_SEND_SUCCESS_RECEIVER_RECEIVED:
                return white ? R.drawable.svg_message_send_success_received_white : R.drawable.svg_message_send_success_received;
            ...
            case MessageStatusCode.STATUS_MESSAGE_SEND_CANCEL:
